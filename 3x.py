...
logo =         \033[2;95m d8888b. d888888b  .o88b. d8888b.    \033[1;97m[\033[1;94m+\033[1;97m] XX \033[1;93m: \033[1;97m Black Panther
...
def main_select():
    ...
    if SYED == '':
        ...
        os.system('xdg-open https://www.instagram.com/its_afridi.143')
        main()
    elif SYED == '4':
        os.system('xdg-open https://facebook.com/groups/3759308667512736/')
        main()
    elif SYED == '0':
        os.system('exit')
    else:
